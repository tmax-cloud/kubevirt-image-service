...
import (
	...
	"github.com/tmax-cloud/kubevirt-image-service/controllers"
...
func main() {
	...
	if err = (&controllers.VirtualMachineImageReconciler{
	...
	if err = (&hypercloudv1alpha1.VirtualMachineImage{}).SetupWebhookWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create webhook", "webhook", "VirtualMachineImage")
		os.Exit(1)
	}
